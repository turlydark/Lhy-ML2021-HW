...
def train(tr_set, dv_set, model, device):
    ...
    optimizer = getattr(torch.optim, config.optimizer)(
        model.parameters(), **config.optim_hyparas)
...
if __name__ == "__main__":
    ...
    tr_path = config.root_path + 'covid.train.csv'  # path to training data
    tt_path = config.root_path + 'covid.test.csv'   # path to testing data


    print(tr_path)
    print(tt_path)

    myseed = config.myseed  # set a random seed for reproducibility
